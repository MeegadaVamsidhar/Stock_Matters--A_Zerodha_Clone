...
const WatchList = () => {
  ...
  useEffect(() => {
    // List of reliable Yahoo Finance symbols for Indian Stocks
    const symbols = "INFY.NS,ONGC.NS,TCS.NS,KPITTECH.NS,WIPRO.NS,RELIANCE.NS";
    
    axios.get(`http://localhost:3002/stock?symbols=${symbols}`)
      .then((res) => {
  ...
  return (
    <div className="watchlist-container">
      ...
      <ul className="list">
        {loading ? (
           <p style={{textAlign:"center", padding: "20px"}}>Loading live market data...</p>
        ) : (
